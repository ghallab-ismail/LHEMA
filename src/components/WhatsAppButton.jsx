    ...
    return (
        ...
        >
            ...
            <motion.a
                ...
                className="relative flex h-14 w-14 items-center justify-center rounded-full bg-lhema-black text-lhema-cream shadow-[0_0_40px_rgba(0,0,0,0.3)] transition-colors hover:bg-lhema-gold"
