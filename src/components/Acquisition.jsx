        ...
        <section className="bg-lhema-cream py-32 pb-48 relative overflow-hidden">
            <div className="mx-auto max-w-lg px-6 relative z-10">
                <div className="mb-16 text-center space-y-6">
                    ...
                    <h3 className="font-serif text-4xl text-lhema-black md:text-5xl">L'Acquisition</h3>
                    ...
                    <p className="text-xs font-sans tracking-widest text-lhema-black/60 uppercase">
                        3 pièces restantes à l'Atelier
                    </p>
                </div>

                <form className="space-y-12 bg-white/50 p-12 backdrop-blur-sm border border-lhema-black/5 shadow-2xl">
                    <div className="group relative">
                        <label className="font-sans text-[10px] uppercase tracking-widest text-lhema-black/40 mb-2 block">Nom Complet</label>
                        <input
                            type="text"
                    ...
                    <div className="group relative">
                        <label className="font-sans text-[10px] uppercase tracking-widest text-lhema-black/40 mb-2 block">Numéro WhatsApp</label>
                        <input
                            type="text"
                            className="w-full border-b border-lhema-black/20 bg-transparent py-2 font-serif text-xl text-lhema-black outline-none transition-colors focus:border-lhema-black"
                        />
                    ...
                    <div className="group relative">
                        <label className="font-sans text-[10px] uppercase tracking-widest text-lhema-black/40 mb-2 block">Ville de Résidence</label>
                        <input
                            type="text"
                            className="w-full border-b border-lhema-black/20 bg-transparent py-2 font-serif text-xl text-lhema-black outline-none transition-colors focus:border-lhema-black"
                        />
